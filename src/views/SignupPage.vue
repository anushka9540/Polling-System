      ...
      <div class="relative flex flex-col items-center justify-center min-h-screen px-4 bg-gray-100 sm:px-0"
        ...
        <div class="relative w-full max-w-sm p-6 -mt-4 bg-white border-gray-400 shadow-2xl rounded-3xl sm:absolute sm:right-10 sm:top-10 sm:mt-0">
          ...
          <div class="mb-4">
            ...
            <div class="flex mt-1 space-x-2 text-gray-700">
              <select class="w-full px-3 py-2 bg-transparent border border-gray-700 rounded hover:border-cyan-600">
                <option>Day</option>
              </select>
              <select class="w-full px-3 py-2 bg-transparent border border-gray-400 rounded hover:border-cyan-600">
                <option>Month</option>
              </select>
              <select class="w-full px-3 py-2 bg-transparent border border-gray-400 rounded hover:border-cyan-600">
                <option>Year</option>
        ...
        <div class="relative flex flex-col items-center justify-center min-h-screen px-4 bg-gray-100 sm:px-0"
          ...
          <div class="relative w-full max-w-sm p-6 -mt-4 bg-white border-gray-400 shadow-2xl rounded-3xl sm:absolute sm:right-10 sm:top-10 sm:mt-0">
            ...
            <div class="mb-4">
              <label class="block text-gray-700">Interested in:</label>
              <div class="flex mt-1 space-x-2">
                <button class="flex-1 py-2 text-gray-800 transition-all duration-300 border-gray-400 border-1 rounded-3xl hover:bg-cyan-100 hover:border-cyan-500">Women</button>
                <button class="flex-1 py-2 text-gray-800 transition-all duration-300 border-gray-400 border-1 rounded-3xl hover:bg-cyan-100 hover:border-cyan-500">Men</button>
                <button class="flex-1 py-2 text-gray-800 transition-all duration-300 border-gray-400 border-1 rounded-3xl hover:bg-cyan-100 hover:border-cyan-500">Both</button>
              </div>
            </div>
            ...
            <div class="mb-4">
              <label class="block text-gray-700">Birthday</label>
              <div class="flex mt-1 space-x-2 text-gray-700">
                <select class="w-full px-3 py-2 bg-transparent border border-gray-700 rounded hover:border-cyan-500">
                  <option>Day</option>
                </select>
                <select class="w-full px-3 py-2 bg-transparent border border-gray-400 rounded hover:border-cyan-500">
                  <option>Month</option>
                </select>
                <select class="w-full px-3 py-2 bg-transparent border border-gray-400 rounded hover:border-cyan-500">
                  <option>Year</option>
            ...
            <div class="mb-4">
              ...
              <input type="text" class="w-full px-3 py-2 mt-1 text-gray-700 bg-transparent border border-gray-400 rounded" />
            </div>
            
            <div class="mb-4">
              <label class="block text-gray-700">Last Name</label>
              <input type="text" class="w-full px-3 py-2 mt-1 bg-transparent border border-gray-400 rounded" />
            </div>
            
            <div class="mb-4">
              <label class="block text-gray-700">Email</label>
              <input type="email" class="w-full px-3 py-2 mt-1 bg-transparent border border-gray-400 rounded" />
            </div>
            
            <div class="mb-4">
              <label class="block text-gray-700">Role</label>
              <select class="w-full px-3 py-2 mt-1 bg-transparent border border-gray-400 rounded">
            ...
            <div class="mb-4">
              <label class="block text-gray-700">Password</label>
              <input type="password" class="w-full px-3 py-2 mt-1 bg-transparent border border-gray-400 rounded" />
            </div>
            ...
            <button @click="handleSignup" class="w-full py-3 text-white rounded-[40px] bg-cyan-500">View Singles</button>
            <p class="pt-3 text-left text-gray-400 text-[11px] leading-loose font-normal ">
              *By selecting "Sign up", you agree to our <a href="#" class="underline">Terms</a> (including the mandatory
              arbitration of disputes) and have understood our <a href="#" class="underline">Privacy Notice</a>.
            </p>
          </div>
