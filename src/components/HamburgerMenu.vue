<template>
  ...
  <transition name="slide-right">
    <aside
      v-if="isSidebarOpen"
      class="fixed top-0 right-0 z-50 h-full bg-white shadow-lg w-full md:w-[470px] md:pl-5 pt-3 flex flex-col md:items-start items-center text-center md:text-left space-y-3 overflow-y-auto"
    >
