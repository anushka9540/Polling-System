<template>
    <div class="flex items-center p-2 mb-4 text-[#374756] border border-gray-300 rounded md:w-[270px] h-20 w-[230px] bg-gray-50">
    ...
    <p v-if="errors.captchaVerified" class="mb-4 text-sm text-red-500">
